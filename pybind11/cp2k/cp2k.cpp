...
void add_class_cp2k(py::module& m) {
    py::class_<atomsciflow::cp2k::Cp2k>(m, "Cp2k")
        ...
        .def("set_job_steps_default", &atomsciflow::cp2k::Cp2k::set_job_steps_default)
...
void add_class_cp2k_static(py::module& m) {
    ...
    py::class_<atomsciflow::cp2k::Static>(m, "Static")
        ...
        .def("set_job_steps_default", &atomsciflow::cp2k::Static::set_job_steps_default)
...
void add_class_cp2k_opt(py::module& m) {
    ...
    py::class_<atomsciflow::cp2k::Opt>(m, "Opt")
        ...
        .def("set_job_steps_default", &atomsciflow::cp2k::Opt::set_job_steps_default)
...
void add_class_cp2k_phonopy(py::module& m) {
    py::class_<atomsciflow::cp2k::Phonopy>(m, "Phonopy")
        ...
        .def("set_job_steps_default", &atomsciflow::cp2k::Phonopy::set_job_steps_default)
