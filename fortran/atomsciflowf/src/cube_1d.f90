module asflowf_cube_1d
    ...
    subroutine cube_1d(cube_file_in)
        ...
        real(kind=dp), allocatable :: data_red_a(:), data_red_b(:), data_red_c(:)
        type(cube) :: cube_i
        ...
        deallocate(data_red_a)
        deallocate(data_red_b)
        deallocate(data_red_c) 
